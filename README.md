...
| --- | --- | --- |
| Logique métier en SQL | 19 tables, 82 fonctions, 26 politiques RLS. Aucun total, coût, marge ni dette n'est calculé en TypeScript | [donnees.md](docs/donnees.md) |
...
métier, donc c'est là que porte la couverture. 221 assertions, portant sur les règles
